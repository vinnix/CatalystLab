...
Catalyst::ScriptRunner->run('Blog::Tutorial', 'Create');
...
blog_tutorial_create.pl [options] model|view|controller name [helper] [options]
 ...
 Examples:
   ...
   blog_tutorial_create.pl model SomeDB DBIC::Schema MyApp::Schema create=dynamic\
   dbi:SQLite:/tmp/my.db
   blog_tutorial_create.pl model AnotherDB DBIC::Schema MyApp::Schema create=static\
